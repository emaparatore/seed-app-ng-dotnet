...
Cloudflare ti dara 2 nameserver (es. `anna.ns.cloudflare.com`, `bob.ns.cloudflare.com`). Vai nel pannello del tuo registrar di dominio e sostituisci i nameserver con quelli di Cloudflare.
