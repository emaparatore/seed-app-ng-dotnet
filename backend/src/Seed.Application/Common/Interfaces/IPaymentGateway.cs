...
public interface IPaymentGateway
{
    ...
    Task<CheckoutSessionCreationResult> CreateCheckoutSessionAsync(CreateCheckoutRequest request, CancellationToken ct = default);
    Task<CheckoutSessionDetails?> GetCheckoutSessionAsync(string sessionId, CancellationToken ct = default);
